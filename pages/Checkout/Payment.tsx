...
const Payment: React.FC = () => {
    ...
    return (
        <View style={styles.paymentContainer}>
            ...
            <TouchableOpacity style={styles.cardOption} onPress={() => navigation.navigate('Addcard')}>
            ...
            {['Paypal', 'Apple Pay', 'Google Pay'].map((method) => (
                ...
                >
                    <Icon
                        name={method === 'Apple Pay' ? 'apple' : method === 'Google Pay' ? 'google' : 'paypal'}
                        size={30}
                        color="#555"
                        style={styles.paymentImage}
                    />
                    <Text style={styles.paymentText}>{method}</Text>
                    {selectedPayment === method && <Text style={styles.selectedText}>Selected</Text>}
                </TouchableOpacity>
            ))}
